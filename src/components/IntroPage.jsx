...
export default function IntroPage({ onNavigate, highlightedCard }) {
  ...
  return (
    <div className="custom-cursor-root intro-page" id="intro-page">
                    ...
                    <div className="hub-card-visual" aria-hidden="true">
                      ...
                      {card.index === '04' && (
                        <div className="preview-skills">
                          <SkillsPageRadar isMiniature={true} />
                        </div>
                      )}
                    </div>
      ...
      {/* 6. Tactical Skills Radar Preview */}
      <section className="intro-radar-section">
        ...
        <div className="pop-text" style={{ transitionDelay: '300ms', width: '100%', display: 'flex', justifyContent: 'center' }}>
          <SkillsPageRadar isPreview={true} />
        </div>
      </section>
